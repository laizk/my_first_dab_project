# my_first_dab_project

The 'my_first_dab_project' project was generated by using the default-python template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] my_first_dab_project_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/my_first_dab_project.job.yml). The schedule
